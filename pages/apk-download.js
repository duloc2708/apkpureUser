...
import ApkDownloadFormView from 'modules/apkdownload/ApkDownloadFormView.js'
import $ from 'jquery';
...
const apkdownload = (props) => (
    <Layout>
        ...
        <ApkDownloadFormView data={props.dataInit} />
    </Layout>
)
apkdownload.getInitialProps = async function (context) {
