import $ from 'jquery';
import DetailFormView from 'modules/blog.detail/DetailFormView.js'
...
const BlogDetail = (props) => (
  <Layout>
    <Head>
      ...
      <meta name="description" content={props.data.desciption} />
      ...
      <meta property="og:description" content={props.data.desciption} />
      {/* <meta property="fb:app_id" content="145923738846814" /> */}
      <meta property="twitter:card" content="summary" />
      <meta property="twitter:title" content={props.data.title} />
      <meta property="twitter:description" content={props.data.desciption} />
...
BlogDetail.getInitialProps = async function (context) {
  ...
  const res = await axios(`${Config.API_URL}video/get_video_detail`, { params: { title_slug: id } })
