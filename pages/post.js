...
const addJSONLD1 = () => {
  return {
    ...
    "@type": "WebSite",
    "name": "apksafety",
    "url": "https://www.apksafety.com/",
    "potentialAction": {
        "@type": "SearchAction",
        "target": "https://www.apksafety.com/search?q=123",
...
const addJSONLD2 = () => {
  return {
    ...
    "name": "apksafety",
    "url": "https://www.apksafety.com/",
    "logo": "https://www.apksafety.com/static/img/logo-d.png",
    "sameAs": [
...
const addJSONLD3 = (type) => {
  return {
    ...
    "itemListElement": [
          ...
          "position": 1,
                      "Item": {
                "@id": "https://www.apksafety.com/${type}",
          "name": ${type}
          }}]`
  };
};
...
const Post = (props) => (
  <Layout>
    <Head>
      ...
      <link rel="apple-touch-icon" href='https://www.apksafety.com/static/img/logo-d.png' />
