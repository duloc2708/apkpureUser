...
class SlideTabletFormView extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            data: [
    ...
    _onChangeDots(key) {
        switch (key) {
            case 1:
                this.setState({ start: 0, end: 2, dots_default: key })
                break;
            case 2:
                this.setState({ start: 3, end: 5, dots_default: key })
                break;
            case 3:
                this.setState({ start: 6, end: 8, dots_default: key })
                break;
            default:
                this.setState({ start: 0, end: 2, dots_default: key })
                break;
...
export default SlideTabletFormView